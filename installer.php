...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210511_lucthaonguyen_46b72225b04c91584043_20210511034456_archive.zip';
	const ARCHIVE_SIZE		 = '306092886';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '46b7222-11034456';
    const SECONDARY_PACKAGE_HASH = 'a48ea64-11034456';
	const VERSION			 = '1.4.0';
